package com.allysonprojects.notes.security.services;
...
//Crucial for integrating custom user model with spring security
//And integrating custom logic and user attributes
